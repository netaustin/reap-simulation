import { govtHours, churchHours, commerceHours, allHours, lateHours, } from './hours.js';

import jail from './places/jail.js';
import heightshousing from './places/heightshousing.js';
...
export default {
  ...
  grocery: {
    ...
    options: [
      {
        title: 'Four-Pack of Ramen Noodles ($7)',
        give: ['ramen', 'ramen', 'ramen', 'ramen'],
        message: `You can cook this at your residence.`,
        money: -7,
        time: 1,
      },
      {
        title: 'A Healthy Frozen Meal ($4)',
        give: ['frozenfood'],
        message: `You can cook this at your residence.`,
        money: -9,
        time: 1,
      ...
      {
        title: 'Pre-wrapped sandwich to eat now ($6)',
        message: `You feel a little better.`,
        food: true,
        money: -6,
        health: 12,
      ...
      {
        title: 'Cheese stick to eat now ($1)',
